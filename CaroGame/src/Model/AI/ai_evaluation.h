...
// constexpr long long SCORE_OPEN2 = 100000; // 100 ngàn   — Tiềm năng tấn công
// tốt constexpr long long SCORE_BLOCKED3 = 10000; // 10 ngàn    — Mối đe dọa
// nhỏ constexpr long long SCORE_BLOCKED2 = 100; constexpr long long SCORE_OPEN1
// = 10; constexpr long long SCORE_BLOCKED1 = 1;
//
// long long CalculateLineScore(int count, int blocks, int gaps);
// long long EvaluatePosition(int r, int c, int piece, bool isBoardEval =
// false);
...
constexpr long long HARD_SCORES[] = {
    1000000000LL,  // WIN        (enum index 0)
    100000000LL,   // OPEN_4     (enum index 1)
    1000000LL,     // BLOCKED_4  (enum index 2) — nguy hiểm nhưng chặn được 1 đầu
    10000000LL,    // OPEN_3     (enum index 3) — PHẢI >> BLOCKED_4 vì sẽ thành OPEN_4
    10000LL,       // BLOCKED_3  (enum index 4)
